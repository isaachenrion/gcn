import os
import pickle
from .datasets import  BatchedFixedOrderGraphDataset, FixedOrderGraphDataset, GraphDataset, GraphDataset2, BatchedGraphDataset
...
def load_from_path(data_path, args):
    ...
    elif isinstance(dataset, GraphDataset2):
